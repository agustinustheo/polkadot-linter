...
- `scripts/check-rustc-hard-rules.sh`: `SEC001` syntax path 0 findings,
  ...
  5 findings; rustc driver rule filter `SEC008,SEC009` emitted exactly those 6
