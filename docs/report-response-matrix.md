...
- `scripts/check-rustc-hard-rules.sh`: `SEC001` syntax path 0 findings,
  ...
  findings; `SEC003` syntax path 4 findings, rustc path 5 findings; `SEC008`
  ...
  3 findings; rustc driver rule filter `SEC008,SEC009` emitted exactly those 4
