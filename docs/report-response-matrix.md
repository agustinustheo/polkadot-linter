...
- `scripts/check-rustc-hard-rules.sh`: `SEC001` syntax path 0 findings,
  ...
  findings; `SEC003` syntax path 11 findings, rustc path 11 findings; `SEC008`
  ...
  9 findings; `SEC012` syntax path 6 findings, rustc path 3 findings; `SEC013`
