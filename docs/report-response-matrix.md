...
Rustc-driver increments now cover `SEC001`, `SEC002`, `SEC003`, `SEC006`,
`SEC007`, `SEC008`, `SEC009`, `SEC010`, `SEC011`, `SEC012`, `SEC013`, `SEC017`,
and `SEC018`. The stable CLI has CI-covered Cargo integration that uses
