...
- `scripts/check-rustc-hard-rules.sh`: `SEC001` syntax path 0 findings,
  rustc path 4 findings, including a whitespace-separated
  ...
  syntax path 0 findings, rustc path 3 findings, including a whitespace-separated
