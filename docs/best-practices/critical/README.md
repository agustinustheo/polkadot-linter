...
*Adapted from [Libro — Polkadot SDK Best Practices](https://libro.blockdeep.dev/critical/index.html) by [BlockDeep](https://github.com/blockdeep/libro), used under the Apache-2.0 license.*
