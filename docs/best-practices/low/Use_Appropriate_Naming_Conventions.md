...
> **Linter coverage — Partial.** [TRM001](../../rules/TRM001.md) enforces configured spelling and terminology conventions in authored text, catching a concrete subset of naming issues. Broader naming design — choosing descriptive, purpose-revealing names and consistent styles — remains review work.
...
*Adapted from [Libro — Polkadot SDK Best Practices](https://libro.blockdeep.dev/low/Use_Appropriate_Naming_Conventions.html) by [BlockDeep](https://github.com/blockdeep/libro), used under the Apache-2.0 license. The **Linter coverage** note above is added by the polkadot-linter project.*
