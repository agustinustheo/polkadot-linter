...
> **Linter coverage — Review gate.** Deciding whether two structures duplicate ownership of the same data is a domain modelling judgement, and no shipping rule detects it.
...
*Adapted from [Libro — Polkadot SDK Best Practices](https://libro.blockdeep.dev/medium/Avoid_Redundant_Data_Structures.html) by [BlockDeep](https://github.com/blockdeep/libro), used under the Apache-2.0 license. The **Linter coverage** note above is added by the polkadot-linter project.*
