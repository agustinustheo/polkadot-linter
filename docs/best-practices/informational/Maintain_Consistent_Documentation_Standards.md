...
> **Linter coverage — Review gate.** No shipping rule enforces documentation standards, since these are project policy decisions requiring human review of completeness and clarity. [TRM001](../../rules/TRM001.md) can check spelling and terminology within the docs you do write, but it is related, not a substitute. See [TRM001](../../rules/TRM001.md).
...
*Adapted from [Libro — Polkadot SDK Best Practices](https://libro.blockdeep.dev/informational/Maintain_Consistent_Documentation_Standards.html) by [BlockDeep](https://github.com/blockdeep/libro), used under the Apache-2.0 license. The **Linter coverage** note above is added by the polkadot-linter project.*
