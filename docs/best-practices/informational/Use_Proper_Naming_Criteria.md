...
> **Linter coverage — Partial.** [TRM001](../../rules/TRM001.md) enforces configured terminology and spelling in authored text, so ambiguous terms like "foreign" or "native" can be flagged once they are added to the dictionary. Broader naming judgment, such as ecosystem research and choosing clearer alternatives, still requires human review. See [TRM001](../../rules/TRM001.md).
...
*Adapted from [Libro — Polkadot SDK Best Practices](https://libro.blockdeep.dev/informational/Use_Proper_Naming_Criteria.html) by [BlockDeep](https://github.com/blockdeep/libro), used under the Apache-2.0 license. The **Linter coverage** note above is added by the polkadot-linter project.*
